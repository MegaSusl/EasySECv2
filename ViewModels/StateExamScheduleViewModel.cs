...
public partial class StateExamScheduleViewModel : ObservableObject
{
    ...
    public StateExamScheduleViewModel() => LoadTemplates();

    private async void LoadTemplates()
    {
        var list = await _templateService.GetTemplatesAsync("state-exam-schedule");
        Templates.Clear();
    ...
    private async Task AddTemplateAsync()
    {
        ...
        await _templateService.AddTemplateAsync(stream, file.FileName, "state-exam-schedule");
        LoadTemplates();
    }
}