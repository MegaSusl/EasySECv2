...
public partial class StateExamScheduleUmuViewModel : ObservableObject
{
    ...
    public StateExamScheduleUmuViewModel() => LoadTemplates();

    private async void LoadTemplates()
    {
        var list = await _templateService.GetTemplatesAsync("state-exam-schedule-umu");
        Templates.Clear();
    ...
    private async Task AddTemplateAsync()
    {
        ...
        await _templateService.AddTemplateAsync(stream, file.FileName, "state-exam-schedule-umu");
        LoadTemplates();
    }
}