...
public partial class SecMemberReplacementViewModel : ObservableObject
{
    ...
    public SecMemberReplacementViewModel() => LoadTemplates();
    ...
    private async Task AddTemplateAsync()
    {
        ...
        await _templateService.AddTemplateAsync(stream, file.FileName, "sec_member_replace");
        LoadTemplates();
    }
}