...
public partial class VkrTopicAssignmentViewModel : ObservableObject
{
    ...
    public VkrTopicAssignmentViewModel() => LoadTemplates();

    private async void LoadTemplates()
    {
        var list = await _templateService.GetTemplatesAsync("vkr-topic-assignment");
        Templates.Clear();
    ...
    private async Task AddTemplateAsync()
    {
        ...
        await _templateService.AddTemplateAsync(stream, file.FileName, "vkr-topic-assignment");
        LoadTemplates();
    }
}