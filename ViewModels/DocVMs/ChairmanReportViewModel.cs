...
namespace EasySECv2.ViewModels.DocVMs;

public partial class ChairmanReportViewModel : ObservableObject
{
    ...
    public ChairmanReportViewModel() => LoadTemplates();

    private async void LoadTemplates()
    {
        var list = await _templateService.GetTemplatesAsync("chairman-report");
        Templates.Clear();
    ...
    private async Task AddTemplateAsync()
    {
        ...
        await _templateService.AddTemplateAsync(stream, file.FileName, "chairman-report");
        LoadTemplates();
    }
}