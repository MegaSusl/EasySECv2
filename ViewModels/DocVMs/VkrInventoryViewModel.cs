...
public partial class VkrInventoryViewModel : ObservableObject
{
    ...
    public VkrInventoryViewModel() => LoadTemplates();

    private async void LoadTemplates()
    {
        var list = await _templateService.GetTemplatesAsync("vkr-inventory");
        Templates.Clear();
    ...
    private async Task AddTemplateAsync()
    {
        ...
        await _templateService.AddTemplateAsync(stream, file.FileName, "vkr-inventory");
        LoadTemplates();
    }
}